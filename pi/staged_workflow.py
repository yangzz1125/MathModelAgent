...
For Chinese CUMCM LaTeX, copy $MATHMODELAGENT_ROOT/pi/latex/cumcm-v1.tex unchanged to paper/cumcm-layout.tex. Use \documentclass[a4paper,12pt]{ctexart}, then \input{cumcm-layout.tex} in the preamble. Replace the old template preamble and title/contents helper definitions with this include; do not redefine papertitle or papercontents. This shared layout loads geometry, amsmath, amssymb, graphicx and booktabs; do not reload geometry or override its margins, font size or line spacing to hit a page target. Keep normal supplementary packages and actual manuscript content in main.tex/sections.
Use \papertitle{the actual title}, the abstract and keywords, then exactly one \papercontents before the first body section. Do not use default \maketitle with empty author/date rows or repeat \tableofcontents. The intentional abstract/contents/body boundaries are not padding; do not force each body section or a short bibliography onto a new page. Other competitions/languages/Typst keep their matching templates rather than this CUMCM layout.
